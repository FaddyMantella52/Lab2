...
public class GameTableRepository {
    ...
    public void addGameTable(GameTable gameTable) {
        String query = "INSERT INTO GameTable (GameTableID, Title, Type, Capacity) VALUES (?, ?, ?, ?)";

        try (PreparedStatement preparedStatement = connection.prepareStatement(query, Statement.RETURN_GENERATED_KEYS)) {
            preparedStatement.setInt(1, gameTable.getGameTableID()); // Assuming you want to insert the provided ID
            preparedStatement.setString(2, gameTable.getTitle());
            preparedStatement.setString(3, gameTable.getType());
            preparedStatement.setInt(4, gameTable.getCapacity());
